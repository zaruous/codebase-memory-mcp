...
const GrammarCase CBM_GRAMMAR_CASES[] = {
    ...
    {"move", CBM_LANG_MOVE, "a.move", "module 0x1::m {\n  public fun foo() {}\n}\n", 1, {"foo", NULL}},
    ...
    {"protobuf", CBM_LANG_PROTOBUF, "a.proto", "syntax = \"proto3\";\n\nmessage Foo {\n  int32 id = 1;\n}\n", 1, {"Foo", NULL}},
    ...
    {"smithy", CBM_LANG_SMITHY, "a.smithy", "namespace example\n\nstructure Foo {\n  id: Integer\n}\n", 1, {"Foo", NULL}},
    {"wit", CBM_LANG_WIT, "a.wit", "interface i {\n  record r { x: u32 }\n  enum e { a, b }\n  f: func() -> u32;\n}\n", 3, {"r", "e", "f", NULL}},
